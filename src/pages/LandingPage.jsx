        ...
        <div className="backdrop-blur-sm bg-white/50 p-6 sm:p-8 md:p-10 rounded-2xl border border-rose-100/50 shadow-xl">
          ...
          >
            <div className="space-y-2 text-center mb-7">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif text-rose-600 leading-tight mb-7">
                {config.data.groomName}
              </h1>
              <div className="h-px w-full max-w-[6rem] sm:max-w-[8rem] mx-auto bg-rose-200 mb-7" />
            </div>
          </motion.div>
